"""入口:python -m data2agent.platform.console [--home C:\\d2a] [--config platform.yaml]
...
from ...shared.admin.auth_token import resolve_token
from ...shared.admin.home_layout import HomeLayout, default_home
from ...shared.admin.secrets_file import apply_secrets_to_environ
